...
MINIZ_EXPORT int mz_compress_no_zlib_headers(unsigned char* pDest, mz_ulong* pDest_len, const unsigned char* pSource, mz_ulong source_len);
...
/* Addition by Gareth Robinson- single call uncompress without zlib headers*/
MINIZ_EXPORT int mz_uncompress_no_zlib_headers(unsigned char* pDest, mz_ulong* pDest_len, const unsigned char* pSource, mz_ulong source_len);
